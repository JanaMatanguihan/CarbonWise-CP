...
print("\n========================================")
print("TFT V2 ROLLING 30-DAY VALIDATION")
print("========================================")
...
print("\n========================================")
print("TFT V2 MULTI-WINDOW VALIDATION RESULTS")
print("========================================")
...
window_metrics_path = (
    "tft/data/tft_v2_validation_window_metrics.csv"
)
...
output_path = (
    "tft/data/tft_v2_validation_predictions.csv"
)
...
plt.plot(
    ...
    label="TFT V2 Predicted"
)

plt.title(
    "TFT V2: Actual vs Predicted Carbon Emissions"
)
...
plot_path = (
    "tft/data/tft_v2_validation_plot.png"
)
