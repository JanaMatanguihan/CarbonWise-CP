...
<div class="max-w-[1800px] mx-auto p-4 space-y-4">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        <!-- Total Users -->
        <div class="bg-white rounded-2xl shadow px-5 py-4 flex items-center gap-4 h-full">
